...
@endcomponent
<h1>Agregar abono del prestamo {{$prestamo->id_prestamo}}</h1>
<div class="card">
...
@csrf <!-- sirve para validar que la petición de los datos enviados provengan del formulario actual (protección contra petición de un recurso de un sitio cruzado) -->
    <input type="hidden" name="fk_id_prestamo" value="{{$prestamo->id_prestamo}}">
    <div class="row my-4">
        <div class="form-group mb-3 col-6">
            <label for="num_abono">Numero de abono</label>
